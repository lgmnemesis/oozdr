export const DictionaryEnglish = {
  ...
  supportTxt: {
    ...
    section1_title: 'Add Beat(s)',
    section1_1: 'Fill in the name and mobile number of the person you \'secretly\' want to reconnect with.',
    section1_2: 'We will NOT let them know you are looking for them at this point.',
